...
1. Run the https://github.com/ssmccoy/gqlgen/blob/master/bin/release:
```
...
5. Go to https://github.com/ssmccoy/gqlgen/releases and draft new release, autogenerate the release notes, and Create a discussion for this release
