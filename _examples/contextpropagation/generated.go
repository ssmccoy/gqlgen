...
func (ec *executionContext) _Query_testTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *Todo) graphql.Marshaler {
			return ec.marshalNTodo2ᚖgithubᚗcomᚋssmccoyᚋgqlgenᚋ_examplesᚋcontextpropagationᚐTodo(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Todo_context(ctx context.Context, field graphql.CollectedField, obj *Todo) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *TodoContext) graphql.Marshaler {
			return ec.marshalNTodoContext2ᚖgithubᚗcomᚋssmccoyᚋgqlgenᚋ_examplesᚋcontextpropagationᚐTodoContext(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) marshalNTodo2githubᚗcomᚋssmccoyᚋgqlgenᚋ_examplesᚋcontextpropagationᚐTodo(ctx context.Context, sel ast.SelectionSet, v Todo) graphql.Marshaler {
	return ec._Todo(ctx, sel, &v)
}

func (ec *executionContext) marshalNTodo2ᚖgithubᚗcomᚋssmccoyᚋgqlgenᚋ_examplesᚋcontextpropagationᚐTodo(ctx context.Context, sel ast.SelectionSet, v *Todo) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNTodoContext2ᚖgithubᚗcomᚋssmccoyᚋgqlgenᚋ_examplesᚋcontextpropagationᚐTodoContext(ctx context.Context, sel ast.SelectionSet, v *TodoContext) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
