...
func (ec *executionContext) _Query_events(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v []Event) graphql.Marshaler {
			return ec.marshalNEvent2ᚕgithubᚗcomᚋssmccoyᚋgqlgenᚋ_examplesᚋunionᚑextensionᚐEventᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) marshalNEvent2githubᚗcomᚋssmccoyᚋgqlgenᚋ_examplesᚋunionᚑextensionᚐEvent(ctx context.Context, sel ast.SelectionSet, v Event) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNEvent2ᚕgithubᚗcomᚋssmccoyᚋgqlgenᚋ_examplesᚋunionᚑextensionᚐEventᚄ(ctx context.Context, sel ast.SelectionSet, v []Event) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNEvent2githubᚗcomᚋssmccoyᚋgqlgenᚋ_examplesᚋunionᚑextensionᚐEvent(ctx, sel, v[i])
	})
