...
func (ec *executionContext) field_Mutation_defaultInput_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input",
		func(ctx context.Context, v any) (DefaultInput, error) {
			return ec.unmarshalNDefaultInput2githubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐDefaultInput(ctx, v)
		})
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) field_Mutation_issue4053_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input",
		func(ctx context.Context, v any) (*Issue4053Input1, error) {
			return ec.unmarshalOIssue4053Input12ᚖgithubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐIssue4053Input1(ctx, v)
		})
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) field_Mutation_overrideValueViaInput_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input",
		func(ctx context.Context, v any) (FieldsOrderInput, error) {
			return ec.unmarshalNFieldsOrderInput2githubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐFieldsOrderInput(ctx, v)
		})
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) field_Mutation_updatePtrToPtr_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input",
		func(ctx context.Context, v any) (UpdatePtrToPtrOuter, error) {
			return ec.unmarshalNUpdatePtrToPtrOuter2githubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐUpdatePtrToPtrOuter(ctx, v)
		})
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) field_Mutation_updateSomething_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input",
		func(ctx context.Context, v any) (SpecialInput, error) {
			return ec.unmarshalNSpecialInput2githubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐSpecialInput(ctx, v)
		})
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) _Mutation_overrideValueViaInput(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *FieldsOrderPayload) graphql.Marshaler {
			return ec.marshalNFieldsOrderPayload2ᚖgithubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐFieldsOrderPayload(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Mutation_updatePtrToPtr(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *PtrToPtrOuter) graphql.Marshaler {
			return ec.marshalNPtrToPtrOuter2ᚖgithubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐPtrToPtrOuter(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) unmarshalNDefaultInput2githubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐDefaultInput(ctx context.Context, v any) (DefaultInput, error) {
	res, err := ec.unmarshalInputDefaultInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNDefaultParametersMirror2githubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐDefaultParametersMirror(ctx context.Context, sel ast.SelectionSet, v DefaultParametersMirror) graphql.Marshaler {
	return ec._DefaultParametersMirror(ctx, sel, &v)
}

func (ec *executionContext) marshalNDefaultParametersMirror2ᚖgithubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐDefaultParametersMirror(ctx context.Context, sel ast.SelectionSet, v *DefaultParametersMirror) graphql.Marshaler {
	if v == nil {
