...
func (ec *executionContext) unmarshalNFieldsOrderInput2githubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐFieldsOrderInput(ctx context.Context, v any) (FieldsOrderInput, error) {
	res, err := ec.unmarshalInputFieldsOrderInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNFieldsOrderPayload2githubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐFieldsOrderPayload(ctx context.Context, sel ast.SelectionSet, v FieldsOrderPayload) graphql.Marshaler {
	return ec._FieldsOrderPayload(ctx, sel, &v)
}

func (ec *executionContext) marshalNFieldsOrderPayload2ᚖgithubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐFieldsOrderPayload(ctx context.Context, sel ast.SelectionSet, v *FieldsOrderPayload) graphql.Marshaler {
	if v == nil {
