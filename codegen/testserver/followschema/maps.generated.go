...
func (ec *executionContext) _MapNested_value(ctx context.Context, field graphql.CollectedField, obj *MapNested) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v CustomScalar) graphql.Marshaler {
			return ec.marshalNCustomScalar2githubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐCustomScalar(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _MapStringInterfaceType_c(ctx context.Context, field graphql.CollectedField, obj map[string]any) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *CustomScalar) graphql.Marshaler {
			return ec.marshalOCustomScalar2ᚖgithubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐCustomScalar(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _MapStringInterfaceType_nested(ctx context.Context, field graphql.CollectedField, obj map[string]any) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *MapNested) graphql.Marshaler {
			return ec.marshalOMapNested2ᚖgithubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐMapNested(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) unmarshalInputMapNestedInput(ctx context.Context, obj any) (MapNested, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "value":
			...
			data, err := ec.unmarshalNCustomScalar2githubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐCustomScalar(ctx, v)
			if err != nil {
				return it, err
			}
			it.Value = data
...
func (ec *executionContext) unmarshalInputMapStringInterfaceInput(ctx context.Context, obj any) (map[string]any, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "c":
			...
			data, err := ec.unmarshalOCustomScalar2ᚖgithubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐCustomScalar(ctx, v)
			if err != nil {
				return it, err
			}
			it["c"] = data
		case "nested":
			...
			data, err := ec.unmarshalOMapNestedInput2ᚖgithubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐMapNested(ctx, v)
			if err != nil {
				return it, err
			}
			it["nested"] = data
...
func (ec *executionContext) unmarshalNCustomScalar2githubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐCustomScalar(ctx context.Context, v any) (CustomScalar, error) {
	var res CustomScalar
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNCustomScalar2githubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐCustomScalar(ctx context.Context, sel ast.SelectionSet, v CustomScalar) graphql.Marshaler {
	return v
}
...
func (ec *executionContext) unmarshalOCustomScalar2ᚖgithubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐCustomScalar(ctx context.Context, v any) (*CustomScalar, error) {
	if v == nil {
		return nil, nil
	}
...
func (ec *executionContext) marshalOCustomScalar2ᚖgithubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐCustomScalar(ctx context.Context, sel ast.SelectionSet, v *CustomScalar) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return v
...
func (ec *executionContext) marshalOMapNested2ᚖgithubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐMapNested(ctx context.Context, sel ast.SelectionSet, v *MapNested) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
...
func (ec *executionContext) unmarshalOMapNestedInput2ᚖgithubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐMapNested(ctx context.Context, v any) (*MapNested, error) {
	if v == nil {
		return nil, nil
	}
...
func (ec *executionContext) unmarshalONestedMapInput2ᚖgithubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐNestedMapInput(ctx context.Context, v any) (*NestedMapInput, error) {
	if v == nil {
		return nil, nil
	}
