...
func (ec *executionContext) marshalNPtrToAnyContainer2githubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐPtrToAnyContainer(ctx context.Context, sel ast.SelectionSet, v PtrToAnyContainer) graphql.Marshaler {
	return ec._PtrToAnyContainer(ctx, sel, &v)
}

func (ec *executionContext) marshalNPtrToAnyContainer2ᚖgithubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐPtrToAnyContainer(ctx context.Context, sel ast.SelectionSet, v *PtrToAnyContainer) graphql.Marshaler {
	if v == nil {
