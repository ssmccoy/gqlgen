...
func (ec *executionContext) marshalOSkipIncludeTestType2ᚖgithubᚗcomᚋssmccoyᚋgqlgenᚋcodegenᚋtestserverᚋfollowschemaᚐSkipIncludeTestType(ctx context.Context, sel ast.SelectionSet, v *SkipIncludeTestType) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
