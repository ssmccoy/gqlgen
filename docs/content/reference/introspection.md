...
To enable introspection for the whole server, you use the bundled middleware extension `github.com/ssmccoy/gqlgen/graphql/handler/extension.Introspection`:
